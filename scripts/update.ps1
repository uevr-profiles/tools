...
try {
    ...
    .\scripts\Update-FromDiscord.ps1 -Fetch -Download -Extract -CleanCache -CleanDownloads -Debug -UseTailscale
    .\scripts\Update-FromUEVRDeluxe.ps1 -Fetch -Download -Extract -CleanCache -CleanDownloads -Debug -UseTailscale
    .\scripts\Update-FromUEVRProfiles.ps1 -Fetch -Download -Extract -CleanCache -CleanDownloads -Debug -UseTailscale
