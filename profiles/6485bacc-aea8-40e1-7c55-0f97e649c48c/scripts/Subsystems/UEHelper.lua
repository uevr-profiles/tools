...
local function CatJump(state)
	if PosDiffSecondaryHand/(MotionMovementStrength/3) >0.3 and PosDiffWeaponHand/(MotionMovementStrength/3) > 0.3 then
		...
		if DiffDistLHMD> 20 and DiffDistRHMD >20 then
