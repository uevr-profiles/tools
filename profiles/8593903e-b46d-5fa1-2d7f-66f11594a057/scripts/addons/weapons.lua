...
local weaponMapping = {
	...
	{name="SteyrAUG", pos={-0.8, -0.8, 2.0}, rot={-0.4, 0.6, 0.0}, scope={ocular_position={-1.350, -11.00, 16.500}, ocular_scale=0.66, objective_rotation={90,0,-90}, fov=5.0, socket="MuzzleSocket", brightness=5.0}},
	...
	{name="ATGM", pos={0.0, 0.3, 0.6}, rot={0.0, 0.0, 0.0}, scope={ocular_position={8.55, -4.15, 17.95}, ocular_scale=0.347, objective_rotation={90,0,90}, fov=5.0, socket="MuzzleSocket", brightness=1.1}},
	{name="IntraTec", pos={0.0, 0.0, 0.0}, rot={0.0, 0.3, 0.0}},
	{name="HKG11", pos={0.0, 0.0, 0.0}, rot={-0.6, 0.7, 0.0}, scope={ocular_position={0, -10.25, 21.4}, ocular_scale=0.66, objective_rotation={90,0,-90}, fov=3.0, socket="MuzzleSocket", brightness=2.0}},
	{name="Spas12", pos={0.0, 0.0, 0.0}, rot={0.0, 0.4, 0.0}},
	{name="MM1GL", pos={-0.5, 0.7, -0.2}, rot={0.0, -0.6, 0.0}},
	{name="Sniper", pos={-2.4, 0.0, 0.0}, rot={-0.1, 0.0, 0.0}, scope={ocular_position={0.3, -6.75, 18.5}, ocular_scale=0.876, objective_rotation={90,0,90}, fov=2.0, socket="TrueMuzzle", brightness=2.0}},
	{name="BarrettM82_explosive", pos={0.0, 0.0, 0.0}, rot={-1.4, 0.0, 0.0}, scope={ocular_position={0.3, -1.95, 16.85}, ocular_scale=1.028, objective_rotation={90,0,90}, fov=2.0, socket="TrueMuzzle", brightness=1.1}},
...
function updateScope(currentWeapon)
	local scopeSettings = getScopeSettings(currentWeapon)
	if scopeSettings ~= nil then
		M.print("Found scope settings. Creating scope")
		local ocularLensComponent, objectiveLensComponent = scope.create({disabled=false, fov=scopeSettings.fov, brightness=scopeSettings.brightness, scale=scopeSettings["ocular_scale"], deactivateDistance=8.75, hideOcularLensOnDisable=true})
