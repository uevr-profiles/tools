...
local function UpdateMaterials()
	pcall(function()
	local testmat=find_required_object("MaterialInstanceConstant /Game/Weapons/Assault_Rifle_01_new/Materials/Rare/06/MI_AssaultRifle_R_06_01.MI_AssaultRifle_R_06_01")
	testmat.bHasStaticPermutationResource=false
	end)
	pcall(function()
	local testmat=find_required_object("MaterialInstanceConstant /Game/Weapons/Assault_Rifle_01_new/Materials/Uncommon/MI_AssaultRifle_U_HandGuard_04.MI_AssaultRifle_U_HandGuard_04")
	testmat.bHasStaticPermutationResource=false
	end)
	pcall(function()
	local testmat=find_required_object("MaterialInstanceConstant /Game/Weapons/Assault_Rifle_01_new/Materials/Uncommon/MI_AssaultRifle_U_Stock_04.MI_AssaultRifle_U_Stock_04")
	testmat.bHasStaticPermutationResource=false
	end)
	pcall(function()
	local testmat=find_required_object("MaterialInstanceConstant /Game/Weapons/Assault_Rifle_01_new/Materials/Uncommon/MI_AssaultRifle_U_Magazine_07.MI_AssaultRifle_U_Magazine_07")
	testmat.bHasStaticPermutationResource=false
	end)
	pcall(function()
	local testmat=find_required_object("MaterialInstanceConstant /Game/Weapons/Assault_Rifle_01_new/Materials/Rare/19/MI_AssaultRifle_R19_01.MI_AssaultRifle_R19_01")
	testmat.bHasStaticPermutationResource=false
	end)
	pcall(function()
	local testmat2= find_required_object("MaterialInstanceConstant /Game/Weapons/Assault_Rifle_01_new/Materials/Uncommon/MI_AssaultRifle_U_Base_01.MI_AssaultRifle_U_Base_01")
	testmat2.bHasStaticPermutationResource=false
	end)
	pcall(function()
	local testmatMag= find_required_object("MaterialInstanceConstant /Game/Weapons/Assault_Rifle_01_new/Materials/Uncommon/MI_AssaultRifle_U_Magazine_01.MI_AssaultRifle_U_Magazine_01")
	testmatMag.bHasStaticPermutationResource=false
	end)
	pcall(function()
	local testmat4= find_required_object("MaterialInstanceConstant /Game/Weapons/Side_Arms/Materials/Common/MI_Pistol_C_01.MI_Pistol_C_01")
	testmat4.bHasStaticPermutationResource=false
	end)
