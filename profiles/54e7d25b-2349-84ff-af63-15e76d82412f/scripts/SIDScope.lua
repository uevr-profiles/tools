...
local function attach_components_to_weapon(weapon_mesh)
	...
	--if not string.find(api:get_local_pawn(0).m_currentEquipment:get_fname():to_string(),"Bino") and not string.find(Get_Scope_Object(api:get_local_pawn(0):GetCurrentArm()):get_fname():to_string(),"Collimator")  then
		...
		scope_mesh = get_scope_mesh(weapon_mesh)--get_scope_mesh(weapon_mesh)
			...
			scope_plane_component:K2_SetRelativeLocation(temp_vec3:set(0, GetComponentOffset(weapon_mesh).y -0.01,GetComponentOffset(weapon_mesh).z ), false, reusable_hit_result, false)--temp_vec3:set(5.310, -21.470,4.860 ), false, reusable_hit_result, false)
		...
		scope_mesh = get_scope_mesh(weapon_mesh)--get_scope_mesh(weapon_mesh)
			...
			black_back_component:K2_SetRelativeLocation(temp_vec3:set(0, GetComponentOffset(weapon_mesh).y,GetComponentOffset(weapon_mesh).z ), false, reusable_hit_result, false)--temp_vec3:set(5.310, -21,4.860  ), false, reusable_hit_result, false)
		...
		if reticle_plane_component then
			...
			reticle_plane_component:K2_SetRelativeLocation(temp_vec3:set(0, GetComponentOffset(weapon_mesh).y-0.02,GetComponentOffset(weapon_mesh).z  ), false, reusable_hit_result, false)
