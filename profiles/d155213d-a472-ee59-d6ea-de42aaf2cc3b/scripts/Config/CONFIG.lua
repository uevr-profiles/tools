...
FirstCatMode = config_table.FirstCatMode_C
DistanceA = config_table.DistanceA_C
...
uevr.sdk.callbacks.on_draw_ui(function()
    ...
    imgui.text("CameraMode: 1=3rdCat, 2=Stable1stCat, 3=Dynamic1stCat")
	FirstCatMode = create_dropdown(" CameraMode ","FirstCatMode_C",{"1","2","3"})
	MotionMovementStrength =   create_slider_int("Needed Motion Strength", "MotionMovementStrength_C", 1,50)
	DistanceA =   create_slider_int("Distance from Head for A Button To trigger", "DistanceA_C", 20,50)
