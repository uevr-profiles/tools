...
function SetMouseLocation(player)
	if isMenu then
		...
		print(rotCurr.Pitch)
		local rotDiff = kismet_math_library:Subtract_VectorVector(rotCurr,rotTemp)
		print(rotTemp.Pitch)
		print(rotDiff.Pitch)
		MouseY =540+ rotDiff.Pitch/90 * 1080
		MouseX =980- rotDiff.Yaw /90*1920
		print(MouseY.. "     " .. MouseX)
		
		player:SetMouseLocation(MouseX,MouseY)
	else rotCurr=nil end
end
