...
local function UpdatePlayerCollisionZones(dpawn)
	...
	if BoxCompHmdLeftHip ~=nil and UEVR_UObjectHook.exists(BoxCompHmdLeftHip) then
		...
		UEVR_UObjectHook.get_or_add_motion_controller_state(BoxCompHmdLeftHip):set_location_offset(Vector3f.new(20,50,0)) -- x=LeftRigth, y = Up down, Z= Forward Backwards
