...
--This function assumes that the finger bones are in sequential order in the boneList
--which is not always the case. Prefer to use doAnimateForFingerWithIndices instead
...
--This function assumes that the finger bones are in sequential order in the boneList
--which is not always the case. Prefer to use setFingerAnglesByIndex instead
...
--This function assumes that the finger bones are in sequential order in the boneList
--which is not always the case. Prefer to use getBoneRotatorByIndex instead
...
--This function assumes that the finger bones are in sequential order in the boneList
--which is not always the case. Prefer to use getBoneTransformsByIndexList instead
function M.getBoneTransforms(component, boneList, includeRotation, includeLocation, includeScale)
	...
	if component ~= nil  then
		if component.GetBoneTransformByName == nil then
			M.print("Component does not support retrieval of bone transforms in function getBoneTransforms() (eg not a poseableMeshComponent)")
		else
			for j = 1, #boneList do
				for index = 1 , 3 do
...
function M.getBoneTransformsByIndexList(component, boneIndexList, includeRotation, includeLocation, includeScale)
	...
	if component ~= nil  then
		if component.GetBoneTransformByName == nil then
			M.print("Component does not support retrieval of bone transforms in function getBoneTransformsByIndexList() (eg not a poseableMeshComponent)")
		else
