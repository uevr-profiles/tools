...
function M.create_component_of_class(className, manualAttachment, relativeTransform, deferredFinish, parent)
	...
	local component = uevr.api:add_component_by_class(baseActor, M.get_class(className), manualAttachment)--local component =  baseActor:AddComponentByClass(M.get_class(className), manualAttachment, relativeTransform, deferredFinish)
