...
--	Visible_Body=true
	--HandIndex=2
	SuperHotSlowMotion_c=false,
	UnlimitedSuperHotMode_c=false
...
UnlimitedSuperHotMode=  config_table.UnlimitedSuperHotMode_c
SuperHotSlowMotion =config_table.SuperHotSlowMotion_c
...
uevr.sdk.callbacks.on_draw_ui(function()
	...
	SuperHotSlowMotion = create_checkbox("Enable SuperHot SlowMotion", "SuperHotSlowMotion_c")
	UnlimitedSuperHotMode = create_checkbox("Unlimited SUperhot Slow", "UnlimitedSuperHotMode_c")
